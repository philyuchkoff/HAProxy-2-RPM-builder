...
### [HAProxy](http://www.haproxy.org/) 2.8.0 2023/05/31
...
### Install (for CentOS8/9 replaсe `yum` to `dnf`):
    ...
    sudo yum -y install /opt/HAProxy-2-RPM-builder/rpmbuild/RPMS/x86_64/haproxy-2.8.0-1.el7.x86_64.rpm

or, if you build *.rpm with Docker:

    sudo yum -y install RPMS/haproxy-2.8.0-1.el7.x86_64.rpm 
