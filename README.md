...
### [HAProxy](http://www.haproxy.org/) 2.9.4 2024/01/31
...
### Install (for CentOS8/9 replaсe `yum` to `dnf`):
    ...
    sudo yum -y install /opt/HAProxy-2-RPM-builder/rpmbuild/RPMS/x86_64/haproxy-2.9.4-1.el7.x86_64.rpm

or, if you build *.rpm with Docker:

    sudo yum -y install RPMS/haproxy-2.9.4-1.el7.x86_64.rpm 
