...
### [HAProxy](http://www.haproxy.org/) 2.5.1 2022/01/11
...
### Install:
    ...
    sudo yum -y install /opt/HAProxy-2-RPM-builder/rpmbuild/RPMS/x86_64/haproxy-2.5.1-1.el7.x86_64.rpm

or, if you build *.rpm with Docker:

    sudo yum -y install RPMS/haproxy-2.5.1-1.el7.x86_64.rpm 
...
Must be like this:
    ...
    HAProxy version 2.5.1-f2e0833 2022/01/11
